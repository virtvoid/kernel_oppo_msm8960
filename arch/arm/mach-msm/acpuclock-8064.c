...
static struct l2_level l2_freq_tbl[] __initdata = {
 	[0]  = { {  270000, HFPLL, 0, 0x00 },  950000, 1050000, 0 },
	[1]  = { {  384000, PLL_8, 0, 0x0C },  950000, 1050000, 1 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   270000, HFPLL, 0, 0x00 }, L2(0),   850000 }, 
	{ 1, {   384000, PLL_8, 0, 0x0C }, L2(1),   875000 },
...
//{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(18, 1175000 },
  ...
  { 1, {  1890000, HFPLL, 1, 0x46 }, L2(18), 1200000 },
  { 1, {  1944000, HFPLL, 1, 0x48 }, L2(19), 1200000 },
	{ 0, { 0 } }
};
